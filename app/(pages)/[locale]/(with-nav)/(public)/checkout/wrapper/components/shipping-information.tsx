  ...
  return (
    <div>
      <h2 className='text-lg font-medium text-gray-900'>
        {dict?.common?.shipping_information || "Shipping information"}
      </h2>
      ...
      <div className='mt-4 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-4'>
        <div>
          ...
          >
            {dict?.common?.first_name || "First name"}{" "}
        ...
        <div>
          <label
            ...
            className='block text-sm/6 font-medium text-gray-700'
          >
            {dict?.common?.last_name || "Last name"}{" "}
            <span className='text-red-600'>*</span>
          </label>
          <div className='mt-2'>
            <Field
        ...
        <div className='sm:col-span-2'>
          <label
            ...
            className='block text-sm/6 font-medium text-gray-700'
          >
            {dict?.common?.address_line2 || "Apartment, suite, etc."}
          </label>
          <div className='mt-2'>
            <Field
              id='address_line2'
        ...
        <div>
          ...
          <div className='mt-2 grid grid-cols-1'>
            ...
            >
              ...
              <option value='TR'>{dict?.common?.turkey || "Turkey"}</option>
              <option value='AE'>{dict?.common?.uae || "UAE"}</option>
            </Field>
          </div>
        </div>
        ...
        <div>
          <label
            ...
            className='block text-sm/6 font-medium text-gray-700'
          >
            {dict?.common?.region || "State / Province"}{" "}
            <span className='text-red-600'>*</span>
          </label>
          <div className='mt-2'>
            <Field
